...
INSERT INTO role_permissions (role, feature, allowed) VALUES
  ...
  -- municipal_assessor
  ('municipal_assessor', 'building_structures.view',   true),
  ('municipal_assessor', 'building_structures.create', true),
  ('municipal_assessor', 'building_structures.edit',   true),
  ('municipal_assessor', 'building_structures.delete', false),
  ('municipal_assessor', 'land_improvements.view',     true),
  ('municipal_assessor', 'land_improvements.create',   true),
  ('municipal_assessor', 'land_improvements.edit',     true),
  ('municipal_assessor', 'land_improvements.delete',   false),
  ('municipal_assessor', 'machinery.view',             true),
  ('municipal_assessor', 'machinery.create',           true),
  ('municipal_assessor', 'machinery.edit',             true),
  ('municipal_assessor', 'machinery.delete',           false),
  ('municipal_assessor', 'accounting.view',            false),
  ('municipal_assessor', 'user_management.view',       false),
  ('municipal_assessor', 'user_management.create',     false),
  ('municipal_assessor', 'user_management.edit',       false),
  ('municipal_assessor', 'user_management.delete',     false),
  ('municipal_assessor', 'role_management.view',       false),
  ('municipal_assessor', 'role_management.edit',       false),
  ('municipal_assessor', 'dashboard.view',             true),
