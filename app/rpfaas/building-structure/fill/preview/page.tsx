            ...
            <div className="bg-white shadow-sm border p-6" id="print-area">
              ...
              <div className="preview-container">
                <div className="mb-2 text-sm text-muted-foreground">
                  Route: <Link href="/rpfaas/building-structure/view" className="text-blue-600 hover:underline">/rpfaas/building-structure/view</Link>
                </div>
                <div className="border p-2 bg-white">
                  <iframe
                  ref={iframeRef}
                  src="/rpfaas/building-structure/view"
