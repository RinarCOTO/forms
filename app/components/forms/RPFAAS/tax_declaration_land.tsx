        ...
        <div className="rpfaas-print space-y-3 tax-dec-body" style={{ backgroundColor: "white" }}>
            ...
            <section className="space-y-1">
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div className="flex gap-2">
                        <div className="w-20 shrink-0">Survey No:</div>
                        <div className="border-b border-black flex-1 font-bold">{fmt(data.survey_no)}</div>
                    </div>
                </div>
                <div className="grid grid-cols-2">
                    <div className="flex gap-2">
                    ...
                    <div className="flex gap-2">
                        <div className="w-20 shrink-0">Lot No:</div>
                        <div className="border-b border-black flex-1 font-bold">{fmt(data.lot_no)}</div>
                    </div>
                </div>
            </section>
            ...
            {/* Property Boundaries */}
            <section className="space-y-1">
                <div className="font-bold italic">Property Boundaries</div>
                <div className="flex gap-2">
                    <div className="w-12 shrink-0">North</div>
                ...
                <div className="flex gap-2">
                    ...
                    <div className="border-b border-black flex-1 font-bold">{fmt(data.west_property)}</div>
                </div>
            </section>
            ...
            <section className="space-y-1">
                <div className="grid grid-cols-2 mt-6 gap-3">
                    <div className="flex gap-2">
                        ...
                        <div className="border-b border-black flex-1 text-center">Land</div>
                    </div>
                    <div className="flex gap-2">
                ...
                <div className="grid grid-cols-5 gap-3 text-center">
                    <div className="border-b border-black w-full mx-auto">{fmt(data.land_class)}</div>
                    <div className="border-b border-black w-full mx-auto"></div>
                    <div className="border-b border-black w-full mx-auto"></div>
                    <div className="border-b border-black w-full mx-auto"></div>
                    <div className="border-b border-black w-full mx-auto"></div>
